...
@section('title', 'Equipos Scrum - Analista - FABRICASOFT')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $projects->sum(function($project) { return $project->phases->where('status', 'active')->count(); }) }}
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                                                                 <a href="{{ route('fabricasoft.analyst.projects.show', $project->id) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('fabricasoft.analyst.dashboard') }}" class="btn btn-sena">
                        <i class="fas fa-arrow-left me-2"></i>Volver al Dashboard
                    </a>
                </div>
            @endif
...
function verFasesActivas(projectId) {
    ...
    window.location.href = "{{ route('fabricasoft.analyst.projects.show', ':id') }}".replace(':id', projectId);
}
</script>
@endpush
