...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $person = Person::where('document_number', '1079174159')->first();
            ...
            $person = Person::where('document_number', 1079174469)->first();
            User::updateOrCreate(['nickname' => 'Deimar'], [
                'person_id' => $person->id,
                'email' => 'deimarguarnizo5@gmil.com@gmail.com',
                'password' => Hash::make('Degu4469'),                   // Password:Degu4469
            ]);
        }
    }
